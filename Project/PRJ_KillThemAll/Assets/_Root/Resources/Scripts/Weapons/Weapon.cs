...
public abstract class Weapon : Item
{
    ...
    public class Stats : LevelData
    {
        ...
        public Melee meleePrefab; // If attached, a meleePrefab hit will spawn when weapon is equipped
        public VFXPrefab hitEffectPrefab;
        ...
        public bool randomTarget, instantiateInOwner, stayInGround, only1Impact,ZScale, PreserveX;
        ...
        public static Stats operator +(Stats s1, Stats s2)
        {
            Stats result = new()
            {
                ...
                meleePrefab = s2.meleePrefab ?? s1.meleePrefab,
                hitEffectPrefab = s2.hitEffectPrefab ?? s1.hitEffectPrefab,
                ...
                randomTarget = s2.randomTarget == false ? s1.randomTarget : s2.randomTarget,
                instantiateInOwner = s2.instantiateInOwner == false ? s1.instantiateInOwner : s2.instantiateInOwner,
                ZScale = s2.ZScale == false ? s1.ZScale : s2.ZScale,
                PreserveX = s2.PreserveX == false ? s1.PreserveX : s2.PreserveX,
            };
            return result;
        }
