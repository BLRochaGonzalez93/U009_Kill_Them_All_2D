...
public class PlayerInventory : MonoBehaviour
{
    ...
    public List<Slot> weaponSlots = new(4);
    public List<Slot> passiveSlots = new(5);
    public UIInventoryIconsDisplay weaponUI, passiveUI;

    [Header("UI Elements")]
    public List<WeaponData> availableWeapons = new();       //List of upgrade options for weapons
    public List<PassiveData> availablePassives = new();     //List of upgrade options for passive items
    ...
    void ApplyUpgradeOptions()
    {
        ...
        List<ItemData> availableUpgrades = new(availableWeapons.Count + availablePassives.Count);
        List<ItemData> allPossibleUpgrades = new(availableWeapons);
