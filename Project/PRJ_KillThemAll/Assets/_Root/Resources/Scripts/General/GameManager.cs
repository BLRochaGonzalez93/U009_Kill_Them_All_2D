...
public class GameManager : MonoBehaviour
{
    ...
    [Header("Damage Text Settings")]
    public AudioSource gameBgm, finishBgm;
    ...
    /*public void AssignChosenWeaponsAndPassiveItemsUI(List<PlayerInventory.Slot> chosenWeaponsData, List<PlayerInventory.Slot> chosenPassiveItemsData)
    {
        ...
        for (int i = 0; i < chosenWeaponsUI.Count; i++)
        {
            ...
            if (chosenWeaponsData[i].item.data.icon)
            {
                ...
                chosenWeaponsUI[i].transform.GetChild(0).transform.GetChild(0).GetComponent<Image>().sprite = chosenWeaponsData[i].item.data.icon;
            }
            else
            {
        ...
        for (int i = 0; i < chosenPassiveItemsUI.Count; i++)
        {
            ...
            if (chosenPassiveItemsData[i].item.data.icon)
            {
                ...
                chosenPassiveItemsUI[i].transform.GetChild(0).transform.GetChild(0).GetComponent<Image>().sprite = chosenPassiveItemsData[i].item.data.icon;
            }
            else
            {
